      ...
      <ul className="space-y-3 p-10">
        <li className="flex gap-2 items-center">
          <svg
            ...
            viewBox="0 0 576 512"
            className="size-6 fill-body-color"
          >
          ...
          <address className="not-italic w-full text-lg">
            {contactData.address}
          </address>
        </li>
        <li className="flex gap-2 items-center">
          ...
          <p className="text-lg text-white">{contactData.phone}</p>
        </li>
        <li className="flex gap-2 items-center">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <a
            href={`https://wa.me/${contactData.whatsapp.replace("08", "628")}`}
            target="_blank"
            rel="noreferrer"
            className="hover:text-secondary hover:underline text-lg"
          >
